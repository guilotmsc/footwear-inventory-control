...
class SaleProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sale_product" do
    assert_difference('SaleProduct.count') do
      post sale_products_url, params: { sale_product: { product_id: @sale_product.product_id, quantity: @sale_product.quantity, sale_id: @sale_product.sale_id, total: @sale_product.total } }
    end
  ...
  test "should update sale_product" do
    patch sale_product_url(@sale_product), params: { sale_product: { product_id: @sale_product.product_id, quantity: @sale_product.quantity, sale_id: @sale_product.sale_id, total: @sale_product.total } }
